 ...
 * 卡片、对话框、按钮、FAB 等统一引用 [MaterialTheme.shapes]。
 */
 ...
 * 应用主题（Material 3）。
 *
 * - [darkTheme]：是否使用深色方案，默认跟随系统。
 * - [dynamicColor]：Android 12+(API 31+) 启用 Material You 动态取色作为增强；
 *   低版本或关闭时回退到上方静态种子色板，保证全版本一致可用且对比度达标。
 */
@Composable
